...
var render = function () {
    ...
    if (isPlaying) {
        ...
        document.getElementById("scoreHTML").innerHTML = `Your score:${score}` // draw the score 
    }
    else {
        bgReady, heroReady, monsterReady === false
    }
...
function timecounting(time) {
    myTime = setInterval(() => {
        ...
        time -= 1
        document.getElementById('timecount').innerHTML = `Time remaining:${time}`
    }, 1000)// every 1 second, it will add 1 into time variable (computer use millisecond so 1000 is 1 second)
}
timecounting(30)// fire the timecounting function!!
...
let backgroundMusic = document.getElementById("myBgMusic");
...
function userName() {
    ...
    document.getElementById("usernameArea").innerHTML = `${name} The Virus Is Now Playing`
}
